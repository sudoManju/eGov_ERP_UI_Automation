		...
		<c:forEach var="docs" items="${applicationFee.applicationFeeDetail}" varStatus="status">
			<div class="form-group">
				<div class="col-sm-5 add-margin check-text text-right">
					...
					<form:input class="form-control patternvalidation"	data-pattern="decimalvalue" maxlength="10"	id="applicationFeeDetail${status.index}amount"		value="${docs.amount}"		readonly="true"	path="applicationFeeDetail[${status.index}].amount"	 />
