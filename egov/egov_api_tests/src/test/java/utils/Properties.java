...
public class Properties {
    ...
    public static final String updatePropertyTypeUrl = propertiesReader.getEndPointUrl("propertyTypeUpdateUrl");
    ...
    public static final String searchDemandUrl = propertiesReader.getEndPointUrl("demandServiceSearchUrl");
    public static final String searchDemandDetailsUrl = propertiesReader.getEndPointUrl("demandDetailsSearchUrl");
    ...
    public static final String wcmsCreatePropertyPipeSizeUrl = propertiesReader.getEndPointUrl("wcmsCreatePropertyPipeSizeUrl");
