...
public class LeaveTypeResource {
    ...
    public Response search(String json) {
        ...
        Response response = given().request().with()
                ...
                .body(json)
                .when()
                .post("http://10.0.0.151:32656/hr-leave/leavetypes/_search?tenantId=ap.kurnool");

        new APILogger().log("Search Leave Type Test Response is Generated as  --" + response.asString() + "&pageSize=100");
        return response;
    }
}
