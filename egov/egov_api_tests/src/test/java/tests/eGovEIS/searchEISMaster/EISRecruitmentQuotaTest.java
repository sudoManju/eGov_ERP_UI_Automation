...
public class EISRecruitmentQuotaTest extends BaseAPITest {
    ...
    public void searchRecruitmentQuotaTest() throws IOException {
        ...
        searchRecruitmentQuota(); // Search RecruitmentQuota
        pilotLogoutService(); // Logout
    }

    private void searchRecruitmentQuota() throws IOException {
        ...
        Response response = new EISMasterResource().
                searchRecruitmentQuotaResource(RequestHelper.getJsonString(searchEmployeeMasterRequest));
