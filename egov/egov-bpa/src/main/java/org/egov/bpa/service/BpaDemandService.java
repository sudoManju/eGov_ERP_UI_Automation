...
public class BpaDemandService {
    ...
    public EgDemandReason getEgDemandReason(BpaFee bpaFee) {
        ...
        egDemandReasonMaster = (EgDemandReasonMaster) demandGenericDao
                .getDemandReasonMasterByCode(bpaFee.getCode(), module);
    ...
    /*@Transactional
    public EgDemandReasonMaster createEgDemandReasonMaster(BpaFee bpaFee) {
        EgDemandReasonMaster egDmdRsnMstr = null;
        Module module = moduleService.getModuleByName(BpaConstants.EGMODULE_NAME);
        egDmdRsnMstr = (EgDemandReasonMaster) demandGenericDao.getDemandReasonMasterByCode(bpaFee.getCode(), module);
        if (egDmdRsnMstr == null) {
            ...
            egDmdRsnMstr.setReasonMaster(bpaFee.getDescription());
            egDmdRsnMstr.setCode(bpaFee.getCode());
    ...
    @Transactional
    public EgDemandReason createEgDemandReason(BpaFee bpaFee, EgDemandReasonMaster egDemandReasonMaster) {
