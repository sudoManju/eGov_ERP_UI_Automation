...
import org.egov.bpa.application.autonumber.ApplicationFeeNumberGenerator;
import org.egov.bpa.application.entity.ApplicationFee;
import org.egov.bpa.application.entity.ApplicationFeeDetail;
import org.egov.bpa.repository.ApplicationFeeRepository;
...
public class ApplicationFeeService {
    ...
    public ApplicationFee saveApplicationFee(ApplicationFee applicationFee) {
        ...
        for (ApplicationFeeDetail applicationFeeDtl : applicationFee.getApplicationFeeDetail()) {
            applicationFeeDtl.setAmount(
                    (applicationFeeDtl.getAmount() != null && !"".equals(applicationFeeDtl.getAmount()))
                            ? applicationFeeDtl.getAmount() : BigDecimal.ZERO);
