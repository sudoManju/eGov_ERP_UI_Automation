...
public class employeeDetails {
    ...
    private boolean isMedicalReportThere;
    ...
    private String permananyPincode;
    ...
    public boolean isMedicalReportThere() {
        return isMedicalReportThere;
    }

    public void setMedicalReportThere(boolean medicalReportThere) {
        isMedicalReportThere = medicalReportThere;
    }
    ...
    public String getPermananyPincode() {
        return permananyPincode;
    }

    public void setPermananyPincode(String permananyPincode) {
        this.permananyPincode = permananyPincode;
    }
